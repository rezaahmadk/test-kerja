...
<html>
<head>
	<title>Menambah Data Kontrak</title>
...
<?php 
	...
	if(isset($_POST['simpan'])){
		$insert = new LibraryKontrak();
		$LamaKontrak = $_POST['LamaKontrak'];
		$insert->CreateKontrak($LamaKontrak);
	}
?>
<body>
    ...
    <main role="main" class="container-fluid main mt-2 mb-2">
		<div class="card">
		  	...
		  	<div class="card-body">
			    <form method="post" action="createkontrak.php">
	        		<div class="form-group">     
	        			<label for="LamaKontrak">Lama Kontrak</label> 	
					      <input name="LamaKontrak" class="form-control" type="text" placeholder="Masukkan Lama Kontrak" autocomplete="off" required="">
					</div>
					<center>
